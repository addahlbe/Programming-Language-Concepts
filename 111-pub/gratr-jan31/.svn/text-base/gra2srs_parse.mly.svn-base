...
%token EOF
%token <Gra2srs_syntax.__term_not_in_ast__> ARROW BAR COLON COMMA DOT LEXICAL LP LS MINUS PLUS QMARK RP RS RULES STAR START SYNTACTIC THICKARROW TILDE VARS WHITESPACE
